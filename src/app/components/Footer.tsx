      ...
      <div className="w-full">
        ...
        >
          ...
          <div className="flex flex-col gap-[2vh]">
            ...
            <p className="text-[#c7d9c7] leading-[1.6]" style={{ fontSize: 'clamp(0.9rem, 1.1vw, 1.1rem)', fontWeight: 400 }}>
          ...
          <div className="flex flex-col gap-[1.5vh] md:text-right">
            <p className="text-[#9cc69c] uppercase tracking-[0.15em]" style={{ fontSize: 'clamp(0.7rem, 0.85vw, 0.85rem)', fontWeight: 500 }}>
              Contact
            </p>
            <a 
            ...
            <p className="text-[#b7cbb7]" style={{ fontSize: 'clamp(0.9rem, 1.05vw, 1.05rem)', fontWeight: 400 }}>
              Helsinki, Finland
            </p>
          </div>
        </motion.div>
        ...
        <div className="border-t border-[#1a3a2a] pt-[4vh]">
          <p className="text-[#9cc69c] text-center md:text-left" style={{ fontSize: 'clamp(0.8rem, 0.95vw, 0.95rem)', fontWeight: 400 }}>
            © RipeSwitch Finland
          </p>
        </div>
      </div>
