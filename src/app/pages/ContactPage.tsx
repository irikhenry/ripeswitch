    ...
    <div className="w-full bg-white min-h-screen">
      ...
      <section id="main-content" className="relative w-full bg-[#026448] min-h-screen flex items-center">
        ...
        <div className="w-full max-w-[1400px] mx-auto px-[5vw] md:px-[8vw] py-[20vh] md:py-[25vh]">
          ...
          <p className="text-white/90 leading-[1.85] max-w-[650px] mb-[6vh]" style={{ fontSize: 'clamp(1rem, 1.2vw, 1.35rem)' }}>
          ...
          <div className="space-y-[3vh]">
            ...
            <p className="text-white/70" style={{ fontSize: 'clamp(1rem, 1.2vw, 1.4rem)' }}>
              Helsinki, Finland
            </p>
          </div>
        </div>
