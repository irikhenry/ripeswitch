    ...
    <div className="w-full bg-white min-h-screen">
      ...
      <section className="relative w-full bg-[#026448] min-h-screen flex items-center">
        ...
        <div className="w-full max-w-[1400px] mx-auto px-[5vw] md:px-[8vw] py-[18vh] md:py-[22vh]">
          <p className="text-white/70 uppercase tracking-[0.22em] mb-[3vh]" style={{ fontSize: 'clamp(0.7rem, 0.8vw, 0.85rem)' }}>
            Technology
          </p>

          <h1 className="text-white leading-[1.05] mb-[5vh] max-w-[980px]" style={{ fontSize: 'clamp(3rem, 6.5vw, 7.5rem)', letterSpacing: '-0.04em' }}>
            How RipeSwitch Works
          </h1>

          <div className="w-24 h-[1px] bg-white/30 mb-[5vh]"></div>

          <p className="text-white/85 leading-[1.7] max-w-[720px]" style={{ fontSize: 'clamp(1rem, 1.2vw, 1.35rem)' }}>
      ...
      <section className="relative w-full min-h-screen bg-white flex flex-col justify-center px-[5vw] md:px-[8vw] py-[8vh] md:py-[10vh]">
        <div className="max-w-[1400px] w-full mx-auto">
          ...
          >
            ...
            <h2 className="text-[#1a1a1a] leading-[1.1] mb-[4vh]" style={{ fontSize: 'clamp(2.2rem, 4.5vw, 5.5rem)', letterSpacing: '-0.02em' }}>
            ...
            <p className="text-[#4a4a4a] leading-[1.7] max-w-[900px] mx-auto" style={{ fontSize: 'clamp(1rem, 1.3vw, 1.5rem)' }}>
              RipeSwitch regulates ripening by managing gas exchange at the fruit interface via engineered paper permeability, not sealed atmospheres.
            </p>
          </motion.div>
          ...
          >
            <div className="w-full lg:w-3/4 lg:mx-auto rounded-3xl overflow-hidden bg-white border border-black/10 shadow-[0_18px_50px_rgba(0,0,0,0.08)]">
              <ImageWithFallback 
                src={mechanismImage}
                alt="RipeSwitch material-based ripening control schematic"
            ...
            <div className="max-w-[900px] mx-auto mt-[6vh] bg-[#f8f8f8] rounded-2xl p-[5vh] md:p-[6vh] border border-[#e0e0e0]">
              <h3 className="text-[#026448] leading-[1.3] mb-[3vh]" style={{ fontSize: 'clamp(1.2rem, 1.4vw, 1.7rem)' }}>
                System architecture
              </h3>
              <p className="text-[#4a4a4a] leading-[1.75] mb-[3vh]" style={{ fontSize: 'clamp(0.95rem, 1.1vw, 1.25rem)' }}>
                The system consists of a structural paper substrate (A), an integrated functional media layer (B), and an internal package environment (C) designed for fresh produce.
              </p>
              <p className="text-[#4a4a4a] leading-[1.75] mb-[3vh]" style={{ fontSize: 'clamp(0.95rem, 1.1vw, 1.25rem)' }}>
                The functional media layer (B) interacts with ethylene generated by fruit respiration while preserving passive permeability to oxygen and water vapour through the paper substrate. The system does not create a sealed or modified-atmosphere enclosure.
              </p>
              <p className="text-[#4a4a4a] leading-[1.75]" style={{ fontSize: 'clamp(0.95rem, 1.1vw, 1.25rem)' }}>
                This architecture enables unit-level ripening modulation in open retail conditions while maintaining recyclability and compliance with fibre-based packaging regulations.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <h2 className="text-[#1a1a1a] leading-[1.1]" style={{ fontSize: 'clamp(2.2rem, 4.5vw, 5.5rem)', letterSpacing: '-0.02em' }}>
          ...
          >
            <div className="inline-block px-5 py-2 bg-[#026448] rounded-full mb-[4vh]">
              <span className="text-white tracking-wider uppercase" style={{ fontSize: 'clamp(0.7rem, 0.85vw, 0.95rem)' }}>
                Manufacturing & Scale
              </span>
            </div>
            <h2 className="text-[#1a1a1a] leading-[1.1] mb-[4vh]" style={{ fontSize: 'clamp(2.2rem, 4.5vw, 5.5rem)', letterSpacing: '-0.02em' }}>
            ...
            <p className="text-[#4a4a4a] leading-[1.7] max-w-[900px] mx-auto" style={{ fontSize: 'clamp(1rem, 1.3vw, 1.5rem)' }}>
              RipeSwitch integrates into existing paper converting operations—no specialized equipment or facilities required.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-[4vh] sm:gap-[3vh] md:gap-[2vw] mb-[14vh] md:mb-[18vh]">
            {[
              ...
              >
                <div className="text-[#026448] leading-none mb-[2vh]" style={{ fontSize: 'clamp(2rem, 2.5vw, 3rem)' }}>
                  {stage.step}
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[4vh] md:gap-[3vw] mb-[14vh] md:mb-[18vh]">
            {[
              ...
              >
                <h4 className="text-[#026448] leading-[1.2] mb-[2vh]" style={{ fontSize: 'clamp(1.2rem, 1.5vw, 1.8rem)' }}>
                  {benefit.title}
                </h4>
          ...
          >
            ...
            <p className="text-[#4a4a4a] leading-[1.7] max-w-[900px] mx-auto" style={{ fontSize: 'clamp(1rem, 1.3vw, 1.5rem)' }}>
              RipeSwitch integrates across multiple packaging configurations to deliver ripening control across produce categories.
            </p>
          </motion.div>
            ...
            >
              <div className="bg-white rounded-3xl border border-[#e0e0e0] overflow-hidden hover:border-[#026448]/30 transition-colors h-full">
                ...
                <div className="p-[5vh] md:p-[6vh]">
                  <h3 className="text-[#1a1a1a] leading-[1.25] mb-[2vh]" style={{ fontSize: 'clamp(1.4rem, 1.8vw, 2.2rem)' }}>
                    High-value produce
                  </h3>
                  <p className="text-[#4a4a4a] leading-[1.7] mb-[3vh]" style={{ fontSize: 'clamp(0.95rem, 1.1vw, 1.3rem)' }}>
                    Optimized for tomatoes, berries, and other delicate fruit that require controlled ripening during distribution and retail display.
                  </p>
          ...
          >
            ...
            <p className="text-[#4a4a4a] leading-[1.7] max-w-[900px] mx-auto mb-[2vh]" style={{ fontSize: 'clamp(1rem, 1.3vw, 1.5rem)' }}>
              Performance estimates are derived from material simulation, laboratory testing, and controlled pilot deployments.
            </p>
            <p className="text-[#666] leading-[1.6] max-w-[800px] mx-auto" style={{ fontSize: 'clamp(0.9rem, 1.05vw, 1.2rem)' }}>
              Outcomes vary by cultivar, temperature profile, and handling conditions.
            </p>
          </motion.div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-[#026448] text-white">
                      <th className="text-left py-[3vh] px-[2vw]" style={{ fontSize: 'clamp(0.85rem, 1vw, 1.15rem)' }}>
                        Fruit
                      </th>
                      <th className="text-left py-[3vh] px-[1.5vw]" style={{ fontSize: 'clamp(0.85rem, 1vw, 1.15rem)' }}>
                        Sensitivity
                      </th>
                      <th className="text-left py-[3vh] px-[1.5vw]" style={{ fontSize: 'clamp(0.85rem, 1vw, 1.15rem)' }}>
                        Shrink
                  ...
                  <tbody>
                    {[
                      ...
                      <tr key={index} className="border-b border-[#e0e0e0] hover:bg-[#f8f8f8] transition-colors">
                        <td className="py-[2.5vh] px-[2vw]" style={{ fontSize: 'clamp(0.9rem, 1.05vw, 1.2rem)' }}>
                          {row.fruit}
                        </td>
                        <td className="py-[2.5vh] px-[1.5vw]">
                          <span className={`inline-block px-2 py-1 rounded-full ${row.sensitivityBg} whitespace-nowrap`} style={{ fontSize: 'clamp(0.75rem, 0.9vw, 1rem)' }}>
                            {row.sensitivity}
                          </span>
                        </td>
                        <td className="py-[2.5vh] px-[1.5vw] text-[#026448]" style={{ fontSize: 'clamp(0.85rem, 1vw, 1.15rem)' }}>
                          {row.shrink}
                        </td>
                        <td className="py-[2.5vh] px-[1.5vw] text-[#026448]" style={{ fontSize: 'clamp(0.85rem, 1vw, 1.15rem)' }}>
                          {row.shelf}
              ...
              <div className="md:hidden divide-y divide-[#e0e0e0]">
                {[
                  ...
                  <div key={index} className="p-[4vh] space-y-[2vh]">
                    <h4 className="text-[#1a1a1a] mb-[1vh]" style={{ fontSize: 'clamp(1.1rem, 1.3vw, 1.5rem)' }}>
                      {row.fruit}
                    </h4>
                    <div className="grid grid-cols-2 gap-[2vh]">
                      <div>
                        <p className="text-[#666] mb-1" style={{ fontSize: 'clamp(0.75rem, 0.9vw, 1rem)' }}>
                          Sensitivity
                        </p>
                        <span className={`inline-block px-3 py-1 rounded-full ${row.sensitivityBg}`} style={{ fontSize: 'clamp(0.8rem, 0.95vw, 1.05rem)' }}>
                          {row.sensitivity}
                        </span>
                      </div>
                      <div>
                        ...
                        <p className="text-[#026448]" style={{ fontSize: 'clamp(0.9rem, 1.05vw, 1.2rem)' }}>
                          {row.shrink}
                        </p>
                      </div>
                      <div>
          ...
          >
            <div className="bg-[#f8f8f8] rounded-3xl p-[6vh] md:p-[8vh] border border-[#e0e0e0]">
              ...
              <h3 className="text-[#1a1a1a] leading-[1.2] mb-[3vh]" style={{ fontSize: 'clamp(1.8rem, 2.8vw, 3.2rem)' }}>
              ...
              <p className="text-[#4a4a4a] leading-[1.75] mb-[3vh]" style={{ fontSize: 'clamp(0.95rem, 1.1vw, 1.3rem)' }}>
                RipeSwitch has validated its core mechanism in laboratory settings and is now in retailer-led pilots to confirm performance under real retail and supply-chain conditions.
              </p>
              
              <h4 className="text-[#026448] leading-[1.3] mb-[2vh]" style={{ fontSize: 'clamp(1.1rem, 1.3vw, 1.5rem)' }}>
              ...
              <p className="text-[#4a4a4a] leading-[1.7]" style={{ fontSize: 'clamp(0.95rem, 1.1vw, 1.25rem)' }}>
                Findings from pilot deployments are used to refine material parameters, packaging formats, and category guidance. Organisations interested in structured validation studies may contact the technical team for pilot protocol details.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="max-w-[800px] mx-auto">
              <h2 className="text-[#EEFF41] leading-[1.1] mb-[3vh]" style={{ fontSize: 'clamp(2rem, 3.5vw, 4.2rem)', letterSpacing: '-0.02em' }}>
                Custom packaging solutions
              </h2>
              <p className="text-white/90 leading-[1.7] mb-[5vh]" style={{ fontSize: 'clamp(1rem, 1.2vw, 1.4rem)' }}>
                We adapt RipeSwitch to your produce categories, package geometries, and supply‑chain requirements—from pilot testing to production scale.
              </p>
          ...
          >
            ...
            <div className="mb-[10vh]">
              ...
              <h2 className="text-[#1a1a1a] leading-[1.2] mb-[2vh]" style={{ fontSize: 'clamp(2rem, 3.5vw, 4.5rem)', letterSpacing: '-0.02em' }}>
                Where we are today
              </h2>
              <p className="text-[#666] leading-[1.6] max-w-[750px]" style={{ fontSize: 'clamp(0.9rem, 1.05vw, 1.2rem)', fontWeight: 300 }}>
                RipeSwitch has validated its core mechanism in laboratory testing and is now moving into pilot production with converters and retailer validation.
              </p>
              ...
              <div className="bg-white border border-[#e0e0e0] rounded-2xl p-[5vh] md:p-[6vh]">
                ...
                <div className="space-y-[3vh] text-[#4a4a4a]" style={{ fontSize: 'clamp(0.95rem, 1.1vw, 1.25rem)', fontWeight: 300 }}>
                  <p className="leading-[1.85]">
                    RipeSwitch is a paper-based packaging system that manages ripening through the package itself, without chemical application to the fruit and with minimal special handling.
                  </p>
                  <p className="leading-[1.85]">
            ...
            <div className="mb-[10vh]">
              <div className="bg-[#f8f8f8] border border-[#e0e0e0] rounded-2xl p-[5vh] md:p-[6vh]">
                ...
                <h3 className="text-[#1a1a1a] leading-[1.3] mb-[4vh]" style={{ fontSize: 'clamp(1.4rem, 1.8vw, 2.2rem)' }}>
                ...
                <div className="pt-[4vh] border-t border-[#e0e0e0] space-y-[3vh]">
                  <p className="text-[#4a4a4a] leading-[1.85]" style={{ fontSize: 'clamp(0.95rem, 1.1vw, 1.25rem)', fontWeight: 300 }}>
                    Testing confirms manufacturability using standard paper substrates and integration into packaging formats suitable for fresh produce.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-[10vh] overflow-visible">
              <div className="mb-[6vh]">
                ...
                <h3 className="text-[#1a1a1a] leading-[1.3] mb-[3vh]" style={{ fontSize: 'clamp(1.6rem, 2vw, 2.5rem)' }}>
                  What’s built and what’s next in 2026
                </h3>
                <p className="text-[#666] leading-[1.75] max-w-[750px]" style={{ fontSize: 'clamp(0.95rem, 1.1vw, 1.25rem)', fontWeight: 300 }}>
                  From validated technology to commercial deployment—current position and next steps.
                </p>
              </div>
                  ...
                  <div className="flex gap-[3vw] min-w-max px-[1vw] overflow-visible">
                    ...
                    <div className="w-[85vw] md:w-[28vw] flex-shrink-0 overflow-visible">
                      <div className="bg-white border-2 border-[#026448] rounded-2xl p-[4vh] h-full relative overflow-visible">
                        ...
                        <ul className="space-y-[1.5vh] text-[#4a4a4a] mb-[3vh]" style={{ fontSize: 'clamp(0.85rem, 0.95vw, 1.05rem)', fontWeight: 300 }}>
                          <li className="leading-[1.6]">• Core mechanism validated in lab settings</li>
                          <li className="leading-[1.6]">• Working prototypes on paper-compatible substrates</li>
                          <li className="leading-[1.6]">• Converting feasibility assessed on existing lines</li>
                        </ul>
                        <div className="pt-[2vh] border-t border-[#e0e0e0]">
                          <p className="text-[#026448] leading-[1.5]" style={{ fontSize: 'clamp(0.8rem, 0.9vw, 1rem)', fontWeight: 500 }}>
                            Next: retailer-led commercial validation to confirm procurement readiness
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="w-[85vw] md:w-[28vw] flex-shrink-0 overflow-visible">
                      <div className="bg-white border-2 border-[#026448] rounded-2xl p-[4vh] h-full relative overflow-visible">
                        ...
                        <ul className="space-y-[1.5vh] text-[#4a4a4a] mb-[3vh]" style={{ fontSize: 'clamp(0.85rem, 0.95vw, 1.05rem)', fontWeight: 300 }}>
                          <li className="leading-[1.6]">• IP filings and scope definition</li>
                          <li className="leading-[1.6]">• Converter alignment for pilot production</li>
                          <li className="leading-[1.6]">• Selecting initial produce categories</li>
                        </ul>
                        <div className="pt-[2vh] border-t border-[#e0e0e0]">
                          <p className="text-[#1a1a1a] leading-[1.5]" style={{ fontSize: 'clamp(0.8rem, 0.9vw, 1rem)', fontWeight: 500 }}>
                            Commercial readiness pathway defined
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="w-[85vw] md:w-[28vw] flex-shrink-0 overflow-visible">
                      <div className="bg-white border border-[#e0e0e0] rounded-2xl p-[4vh] h-full relative overflow-visible">
                        ...
                        <ul className="space-y-[1.5vh] text-[#4a4a4a] mb-[3vh]" style={{ fontSize: 'clamp(0.85rem, 0.95vw, 1.05rem)', fontWeight: 300 }}>
                          <li className="leading-[1.6]">• First converter trial batches</li>
                          <li className="leading-[1.6]">• Integration on existing lines</li>
                          <li className="leading-[1.6]">• Production cost verification</li>
                        </ul>
                        <div className="pt-[2vh] border-t border-[#e0e0e0]">
                          <p className="text-[#1a1a1a] leading-[1.5]" style={{ fontSize: 'clamp(0.8rem, 0.9vw, 1rem)', fontWeight: 500 }}>
                    ...
                    <div className="w-[85vw] md:w-[28vw] flex-shrink-0 overflow-visible">
                      <div className="bg-white border border-[#e0e0e0] rounded-2xl p-[4vh] h-full relative overflow-visible">
                        ...
                        <ul className="space-y-[1.5vh] text-[#4a4a4a] mb-[3vh]" style={{ fontSize: 'clamp(0.85rem, 0.95vw, 1.05rem)', fontWeight: 300 }}>
                          <li className="leading-[1.6]">• In‑store pilots with retail partners</li>
                          <li className="leading-[1.6]">• Measuring shrink reduction in‑market</li>
                          <li className="leading-[1.6]">• Tracking shelf‑life performance</li>
                        </ul>
                        <div className="pt-[2vh] border-t border-[#e0e0e0]">
                          <p className="text-[#1a1a1a] leading-[1.5]" style={{ fontSize: 'clamp(0.8rem, 0.9vw, 1rem)', fontWeight: 500 }}>
                    ...
                    <div className="w-[85vw] md:w-[28vw] flex-shrink-0 overflow-visible">
                      <div className="bg-white border border-[#e0e0e0] rounded-2xl p-[4vh] h-full relative overflow-visible">
                        ...
                        <ul className="space-y-[1.5vh] text-[#4a4a4a] mb-[3vh]" style={{ fontSize: 'clamp(0.85rem, 0.95vw, 1.05rem)', fontWeight: 300 }}>
                          <li className="leading-[1.6]">• Refinement based on pilot results</li>
                          <li className="leading-[1.6]">• Converter capacity planning</li>
                          <li className="leading-[1.6]">• Commercial rollout readiness</li>
                        </ul>
                        <div className="pt-[2vh] border-t border-[#e0e0e0]">
                          <p className="text-[#1a1a1a] leading-[1.5]" style={{ fontSize: 'clamp(0.8rem, 0.9vw, 1rem)', fontWeight: 500 }}>
                    ...
                    <div className="w-[85vw] md:w-[28vw] flex-shrink-0 overflow-visible">
                      <div className="bg-white border border-[#e0e0e0] rounded-2xl p-[4vh] h-full relative overflow-visible">
                        ...
                        <ul className="space-y-[1.5vh] text-[#4a4a4a] mb-[3vh]" style={{ fontSize: 'clamp(0.85rem, 0.95vw, 1.05rem)', fontWeight: 300 }}>
                          <li className="leading-[1.6]">• Initial retailer deployments</li>
                          <li className="leading-[1.6]">• European expansion planning</li>
                          <li className="leading-[1.6]">• Converter licensing strategy</li>
                        </ul>
                        <div className="pt-[2vh] border-t border-[#e0e0e0]">
                          <p className="text-[#1a1a1a] leading-[1.5]" style={{ fontSize: 'clamp(0.8rem, 0.9vw, 1rem)', fontWeight: 500 }}>
                            Market entry underway
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="mt-[8vh] bg-[#f8f8f8] border border-[#e0e0e0] rounded-2xl p-[4vh] md:p-[5vh]">
                ...
                <p className="text-[#4a4a4a] leading-[1.85]" style={{ fontSize: 'clamp(0.9rem, 1.05vw, 1.2rem)', fontWeight: 300 }}>
                  RipeSwitch is developed with converters and retailers. Each phase is validated on production lines and in‑store conditions. Commercial rollout is planned for end‑2026; new partners are invited.
                </p>
              </div>
            </div>
